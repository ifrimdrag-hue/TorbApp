...
- `[x]` **Modul P&L** — relocat din `pnl_app` standalone în TorbApp (migrația 0033, rute `/pnl/*`, import balanțe `.xls`, export Excel). Livrat 2026-07-07 — vezi CHANGELOG. De făcut la deploy: owner-ul încarcă balanțele prin `/pnl/import` pe dev/prod (datele nu se pushează).
